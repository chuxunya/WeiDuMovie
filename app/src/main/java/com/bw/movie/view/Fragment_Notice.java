...
 *@Description:预告
 **/
public class Fragment_Notice extends BaseFragment<HomePresenter> implements IContract.IView {
    ...
    public void onXiangSuccess(XiangBean xiangBean) {
        ...
        if (xiangBean.getResult()==null){
            ...
            recyNotice.setLayoutManager(linearLayoutManager);
            MyAdapter_notice myAdapter_notice = new MyAdapter_notice(shortFilmList, getActivity());
            recyNotice.setAdapter(myAdapter_notice);
        }
    }
