...
/**
 *@describe(描述)：MoreActivity
 *@data（日期）: 2019/12/6
 *@time（时间）: 16:53
 *@author（作者）: xin
 **/
public class MoreActivity extends BaseActivity<HomePresenter> implements IContract.IView {

    @BindView(R.id.fanhui_more)
    ImageView fanhuiMore;
    @BindView(R.id.edit_serach_more)
    EditText editSerachMore;
    ...
    protected void initData() {
        ...
        list.add(new FragZzry());
        list.add(new FragJJSS());
        list.add(new FragRMDY());
        ...
        vpMore.setOffscreenPageLimit(3);
    }
    ...
    @OnClick({R.id.fanhui_more, R.id.btn})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.fanhui_more:
                finish();
                break;
            case R.id.btn:
