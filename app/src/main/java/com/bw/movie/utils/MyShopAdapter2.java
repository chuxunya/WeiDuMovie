...
/**
 *@describe(描述)：MyShopAdapter2
 *@data（日期）: 2019/11/14
 *@time（时间）: 21:11
 *@author（作者）: xin
 **/
public class MyShopAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<FuBean.ResultBean> list;
    private Context context;
    private View inflate;

    public MyShopAdapter2(List<FuBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    MyShopAdapter.OnclickListener onclickListener;

    public void setOnclickListener(MyShopAdapter.OnclickListener onclickListener) {
