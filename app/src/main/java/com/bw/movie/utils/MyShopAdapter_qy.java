 ...
 *@author（作者）: xin
 **/
public class MyShopAdapter_qy extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Choose_qy_Bean.ResultBean> list;
    private Context context;
    private View inflate;

    public MyShopAdapter_qy(List<Choose_qy_Bean.ResultBean> list, Context context) {
        this.list = list;
