 ...
 *@author（作者）: xin
 **/
public class MyShopAdapter_day extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Choose_day_bean.ResultBean> list;
    private Context context;
    private View inflate;

    public MyShopAdapter_day(List<Choose_day_bean.ResultBean> list, Context context) {
        this.list = list;
